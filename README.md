...
El repositorio tiene dos pruebas unitarias de testing utilziando el metodo unittest
- Prueba a la funcion cargue de imagen: python -m unittest test_1
- Prueba a la funcion de procesamiento de imagen python -m unittest test_2

## Requisitos de visualizacion de Xlauch

Para Windows debe instalar la interfaz xlaunch: https://sourceforge.net/projects/vcxsrv/

Esta guia podria ayudarle a instalar la herramienta de interfaz https://dev.to/darksmile92/run-gui-app-in-linux-docker-container-on-windows-host-4kde
...
## Actualizado por:
Cristian Perlaza - https://github.com/cristianperlaza
Ivan Sanclemente - https://github.com/ivansanclemente
